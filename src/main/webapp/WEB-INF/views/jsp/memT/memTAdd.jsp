    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="memtype" id="memTName" autocomplete="off" placeholder="请输入会员类型名"
                   class="layui-input" lay-verify="require" lay-verType="tips">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="discount" id="discount" autocomplete="off" placeholder="请输入折扣 [0.1,1.0]"
                   class="layui-input" lay-verify="require|number|discount" lay-verType="tips">
        </div>
    </div>
...
<script>
    layui.use(['form', 'layedit', 'laydate'], function () {
        ...
        form.on('submit(demo1)', function (data) {
            $.ajax({
                url: '<%=request.getContextPath()%>/memT/add',
                type: 'post',
