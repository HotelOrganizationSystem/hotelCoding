...
<script type="text/html" id="toolbar">
  ...
  <h2 style="text-align: center; margin-top: -30px">房间类型</h2>
</script>
<script type="text/html" id="img">
  <div onclick="show_img(this)">
    <img src="${pageContext.request.contextPath}{{d.defimg}}"  style="width: 40px; height: 40px;">
  </div>
</script>
<script src="../static/common/rtype/rtypeList.js?<%=Math.random()%>"></script>
