...
<div id="app">
    ...
    <div class="main" id="app">
        ...
        <div class="right">
            ...
            <form class="layui-form " action="${pageContext.request.contextPath}/users/updatePwd" onsubmit="return sumbit_sure()">

                <div class="layui-form-item">
                    <label class="layui-form-label">账号</label>
                    <div class="layui-input-block">
                        <input type="text"   VALUE="${user.account}" class="layui-input" readonly="readonly"/>
                    </div>
                </div>
